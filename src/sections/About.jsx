...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us - Try Unity Solutions</title>
        <meta name="description" content="Learn about Try Unity Solutions, our mission, values, and the expertise that drives our custom MERN stack web applications." />
        <meta name="keywords" content="About Try Unity Solutions, company mission, MERN stack, web development team, business values" />
        <meta name="author" content="Try Unity Solutions" />
        <link rel="canonical" href="https://tryunitysolutions.vercel.app/#about" />
      </Helmet>
      <MotionBox
        id="about"
        p={8}
