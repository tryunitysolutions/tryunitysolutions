...
const Projects = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Projects - Try Unity Solutions Portfolio</title>
        <meta name="description" content="Explore our portfolio of custom MERN stack web applications and business solutions delivered by Try Unity Solutions." />
        <meta name="keywords" content="Try Unity Solutions projects, MERN stack portfolio, web app case studies, business solutions" />
        <meta name="author" content="Try Unity Solutions" />
        <link rel="canonical" href="https://tryunitysolutions.vercel.app/#projects" />
      </Helmet>
      <MotionBox
        id="projects"
        p={8}
