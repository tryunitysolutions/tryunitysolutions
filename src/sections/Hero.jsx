...
const Hero = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Welcome - Try Unity Solutions | Custom MERN Web Apps</title>
        <meta name="description" content="Welcome to Try Unity Solutions. We build fast, scalable, and custom MERN stack applications tailored for your business needs." />
        <meta name="keywords" content="MERN stack, business web apps, custom web development, Try Unity Solutions" />
        <meta name="author" content="Try Unity Solutions" />
        <link rel="canonical" href="https://tryunitysolutions.vercel.app/" />
      </Helmet>
      <MotionBox
        id="welcome"
        minH="100vh"
